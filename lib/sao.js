...
const download = require('sao/lib/utils/download');
const configUtils = require('sao/lib/utils/config');
const event = require('sao/lib/utils/event');
const mockPrompt = require('sao/lib/mock-prompt');
const log = require('sao/lib/utils/log');
const parseTemplate = require('sao/lib/utils/parse-template');
...
module.exports = co.wrap(function*({
	...
	if (parsed.type === 'local') {
		...
		const packageName = parsed.scoped ? `@${parsed.user}/${parsed.name}` : parsed.name;
	...
	const templateVersion = templatePkg ? templatePkg.version : parsed.version || '';
